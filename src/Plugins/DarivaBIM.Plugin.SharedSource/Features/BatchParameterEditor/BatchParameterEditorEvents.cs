...
namespace DarivaBIM.Plugin.Features.BatchParameterEditor
{
    ...
    /// </summary>
    public class BatchParameterEditorSelectionExternalEvent
    {
        private readonly BatchParameterEditorSelectionHandler _handler;
        private readonly ExternalEvent _externalEvent;

        public BatchParameterEditorSelectionExternalEvent()
        {
            _handler = new BatchParameterEditorSelectionHandler();
    ...
    internal class BatchParameterEditorSelectionHandler : IExternalEventHandler
    {
        ...
        {
            BatchParameterEditorWindow? win = Window;
            if (win == null)
                return;
            ...
            try
            {
                ...
                IReadOnlyList<CommonParameterOption> common =
                    BatchParameterEditorService.ComputeCommonParameters(elements);
    ...
    public class BatchParameterEditorApplyExternalEvent
    {
        private readonly BatchParameterEditorApplyHandler _handler;
        private readonly ExternalEvent _externalEvent;

        public BatchParameterEditorApplyExternalEvent()
        {
            _handler = new BatchParameterEditorApplyHandler();
            _externalEvent = ExternalEvent.Create(_handler);
        }
    ...
    internal class BatchParameterEditorApplyHandler : IExternalEventHandler
    {
        ...
        public string GetName() => "EvtBim.BatchParameterEditorApplyHandler";
        ...
        public void Execute(UIApplication app)
        {
            ...
            try
            {
                ...
                foreach (ElementId id in Ids)
                {
                    ...
                    Element top = BatchParameterEditorService.GetTopSuperComponent(el);
                ...
                List<Element> targets = BatchParameterEditorService
                ...
                foreach (Element elem in targets)
                {
                    ...
                    Parameter? param = BatchParameterEditorService.FindParameter(elem, Parameter);
                    if (param == null)
                    {
    ...
    internal static class BatchParameterEditorService
    {
        /// <summary>
